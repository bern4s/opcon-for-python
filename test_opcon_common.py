...
class TestOpConMaterialItems:
    ...
    def test_opcon_material_items_gtl_label(self):
        ...
        items = list(
            opcon_common.NewOpConMaterialItems(
                f"""[)>0612PGTL39K121J{PACKAGE_ID}14D{EXPIRATION_DATE}16D{PRODUCTION_DATE}P{TYPE_NO}2P{TYPE_VAR}1T{BATCH_1}Q{QUANTITY}3Q{QUANTITY_UNIT}K{ORDERING_NO}4K0012SGY202212310115K123V{SUPPLIER_ID}13V{SUPPLIER_ID_DUNS}7Q{GROSS_WEIGHT_KG}2K{SHIPPING_NOTE_NO}23P{PART_ADD_INFO}30PNA12V{MANUFACTURER}1P{MANUFACTURER_TYPE_NO}33TY""",  # noqa: E501
